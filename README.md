...
透過本次報告，當我觀察數據時，看到 $O(n^2)$ 演算法在面對十萬筆資料時的慢速，與 $O(n \log n)$ 演算法的秒速完成，那種對比讓我體悟到，作為一名開發者，思考優化演算法對系統效能的提升，遠比單純追求硬體升級來得更加重要。也是第一次學習到資料的排序有那麼多種方式，更建立了我對計算資源分配與效能權衡的觀察判斷力。
